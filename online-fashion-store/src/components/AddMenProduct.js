...
export default class AddMenProduct extends Component {
...
render(){
    return (
      ...
      {/* <FormGroup>
        ...
        <Input type="select" name="categories" id="exampleSelect" onChange={this.handleGenderChange.bind(this)}>
